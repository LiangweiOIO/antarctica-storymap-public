...
export default {
    ...
    async mounted() {
        ...
        try {
            ...
            let dom = document.getElementById('china-stations');
    ...
    methods: {
        drawmap(width, height) {
            ...
            this.drawpoints(svg, projection, width, height);

            return svg.node();
        },
        drawpoints(map, projection, width, height) {
            // console.log(typeof (this.stations))
